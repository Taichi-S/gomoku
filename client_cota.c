			...
			{ //対象座標が、先行の相手が置いたもの
				...
				{				 //対象座標から八方（４X２）を走査
					...
					{						//対象座標から三々禁となりうる直線上の範囲を走査
						...
						if (board[mj - 1 + xweight][ki - 1 + yweight] == 1 && white_in_plus_flag == 0)
						...
						if (board[mj - 1 - xweight][ki - 1 - yweight] == 1 && white_in_minus_flag == 0)
